...
return {
    en = {
        ...
        credits = 'this is simple bot for manage group\n edited by Avirateam\n our channel [avira team](https://telegram.me/avirateam)',
        extra = {
        ...
        help = {
            ...
            all = '*Commands for all*:\n'
		            ...
		            ..'\n\nIf you like this bot, please leave the vote you think it deserves [here](https://telegram.me/storebot?start=Aviragpbot)',
		    private = 'Hey, *&&&1*!\n'
                    ...
                    ..'\n\n[Official channel](https://telegram.me/avirateam) and [vote link](https://telegram.me/storebot?start=Aviragpbot)',
	...
	pe = {
        bonus = {
		    general_pm = '_من پیغام را به پیوی شما ارسال کردم_',
            no_user = '*من این فرد را تا به حال ندیده ام،اگر میخواهید به من بیاموزید او کیست پیغامی از او برایم فورواردکنید*',
            the_group = '*گروه*',
            mods_list = '*لیست گروه ها*\n&&&1',
            settings_header = 'تنظیمات کنونی گروه \n زبان\n &&&1 \n',
            reply = '`برای استفاده از دستور بر روی فرد مورد نطر ریپلی کنید`',
            msg_me = '`به من پیغام دهید تا بتوانم پاسخ شمارا بدهم`'
        },
        pv = '`این دستور فقط مخصوص گروه می باشد`',
        not_mod = '`شما مدیر نیستید',
        breaks_markdown = 'This text breaks the markdown.\nCheck how many times you used * or _ or `',
        ping= 'آنلاینم:|',
        control = {
            reload = '*تمام پلاگین های ربات دوباره اجرا شد*',
            stop = '*در حال متوقف کردن ربات*'
        },
        credits = 'این ربات برای مدیریت بهتر گروه به شما کمک میکند\n*ترجمه و ادیت شده توسط تیم اویرا*\n[کانال ما](https://telegram.me/avirateam)\nاگر ربات مارا دوست داشتید  به ما امتیاز دهید\n[امتیاز](https://telegram.me/storebot?start=avitagpbot)',
        extra = {
			usage = 'Write next to /extra the title of the command and the text associated.\nFor example:\n/extra #motm stay positive. The bot will reply _\'Stay positive\'_ each time someone writes #motm',
            new_command = '*دستور جدید ثبت شد*\n&&&1\n&&&2',
            no_commands = '*دستوری ثبت نشده است*',
            commands_list = '*لیست دستورات متفرقه*:\n&&&1',
            command_deleted = '&&&1 دستور پاک شد',
            command_empty = '&&&1 دستور موجود نیست'
        },
        getstats = {
            redis = 'Redis updated',
            stats = '&&&1'
        ...
        help = {
            owner = '*دستورات مخصوص مدیران گروه*:\n'
                    ..'`/owner` \n(با ریپلی) : تعیین مدیر گروه\n'
                    ..'`/promote` \n (باریپلی|یوزرنیم) : ادمین کردن فرد\n'
                    ..'`/demote` \n (با ریپلی|بایوزرنیم) : حذف ادمین\n'
                    ..'`/setlink` \n  تعیین لینک گروه\n\n',
                    
            moderator = '*دستورات مخصوص معاونان گروه*:\n'
                        ..'`/menu` \n مدیریت تنظیمات گروه در پیوی\n'
                        ..'`/kick` \n(باریپلی|یوزرنیم) : اخراج فرد از گروه\n'
                        ..'`/ban` \n(باریپلی|یوزرنیم)  بن فرد از گروه\n'
                        ..'`/unban` \n(باریپلی|یوزرنیم)  ان بن کردن فرد \n'
                        ..'`/flood [kick/ban]` \n  نوع واکنش به اسپم \n'
                        ..'`/flood [on/off]` \n خاموش یا روشن کردن حساسیت به اسپم\n'
                        ..'`/flood [number]` \n تعیین میزان حساسیت\n'
                        ..'`/setrules <rules>` \n تعیین قوانین\n'
                        ..'`/addrules <rules>` \n اضافه کردن متن به قوانین\n'
                        ..'`/setabout <bio>` \n تعیین بیو گرافی گروه\n'
                        ..'`/addabout <bio>` \n اضافه کردن متن به بیوگرافی\n'
                        ..'`/media [kick|ban|allow] [type]` \n نوع واکنش به ارسال رسانه\n'
                        ..'`/media` \n مشاهده تنظیمات رسانه\n'
                        ..'`/link` \n دریافت لینک گروه\n'
                        ..'`/lang` \n مشاهده لیست زبان های موجود\n'
                        ..'`/lang` [code] \n تغییر زبان ربات\n'
                        ..'`/settings` \n مشاهده تنظیمات گروه\n'
                        ..'`/warn [kick/ban]` \n نوع واکنش به هشدحداکثر هشدار\n'
                        ..'`/warn` (با ریپلی) \n هشدار به فرد\n'
                        ..'`/getwarns` (با ریپلی) \n مشاهده هشدار های فرد\n'
                        ..'`/nowarns` (با ریپلی) \n ریست کردن هشدار های فرد\n'
                        ..'`/warnmax` \n تعیین میزان حداکثر هشدار\n'
                        ..'`/extra` [#trigger] [reply] \n تعیین دستور جدید\n'
                        ..'`/extra list` \n مشاهده لیست دستورات\n'
                        ..'`/extra del` [#trigger] \n حذف دستور\n'
                        ..'`/setpoll [link|\'no\']` \n ذخیره لینک نظر سنجی از @pollbot\n'
                        ..'`/poll` \n مشاهده لینک نظرسنجی\n'
                        ..'`/disable [arab|rtl]` \n قفل کردن عربی\n'
                        ..'`/enable [arab|rtl]` \n اجازه ارسال متن عربی\n'
                        ..'`/disable <rules|about|modlist|extra>` \n فقط مدیران میتوانند از این دستور استفاده کنند\n'
                        ..'`/enable <rules|about|modlist|extra>` \n این دستورات برای همه قابل استفاده میشوند\n'
                        ..'`/enable|/disable <welcome|report>` \n خاموش یا روشن کردن خوشامدگویی\n'
                        ..'`/report [on/off]` (با ریپلی) \n ریپورت فرد\n'
                        ..'`/welcome <no|r|a|ra|ma|rm|rma|custom text>` \n نوع پیغام خوشامدگویی\n'
                        ..'_custom_ \n تعیین پیغام خوشامدگویی دلخواه (شما متوانید از *$username*, *$name*, *&title* (chat title) استفاده کنید)\n'
                        ..'_no_ \n معمولي\n'
                        ..'_r_ \n پيام خوشامد گويي با قواانين ارسال شود\n'
                        ..'_a_ \n پيغام خوشامد گويي با متن توضيحات ارسال شود\n'
                        ..'_m_ \n پيغام خوشامد گويي با ليست مديران ارسال شود\n'
                        ..'_ra|ar_ \n پيغام خوشامد گويي با متن توضيحات و قوانين ارسال شود\n'
                        ..'_ma|am_ \n پيغام خوشامد گويي همراه با ليست مديران ارسال شود\n'
                        ..'_rm|mr_ \n پيغام خوشامد گويي همراه با ليست مديران و قوانين ارسال شود\n'
                        ..'_ram|rma|mar|mra|arm|amr_ : پيغام خوشامد گويي همراه با ليست مديران متن توضيحات و قوانين ارسال شود\n\n',
            all = '*دستورات همگانی*:\n'
                    ..'`/dashboard` : مشاهده مشخصات گروه در پیوی\n'
                    ..'`/rules` (if unlocked) : مشاهده قوانین\n'
                    ..'`/about` (if unlocked) : مشاده متن توضیحات\n'
                    ..'`/modlist` (if unlocked) : مشاده لیست مدیران\n'
                    ..'`/tell` : مشاده مشخصات فرد مورد نظر\n'
                    ..'`/info` : مشاهده مشخصات گروه\n'
                    ..'`/c` <feedback> : ارسال فیدبک\n'
                    ..'`/help` : مشاهده این پیغام'
		            ..'\n\nاگر مارا دوست داشتید به ما  امتیاز دهید \n[لینک امتیاز](https://telegram.me/storebot?start=aviragpbot)',
		    private = 'سلام, *&&&1*!\n'
                    ..'من یک ربات ساده برای مدیریت اسان تر گروه شما هستم\n'
                    ..'\n*چگونه میتوانم به شمما کمک کنم؟*\n'
                    ..'خب من تنظیمات و امکانات زیادی دارم مثل کیک یا بن اعضا هشدار دادن به اعضا و ...'
                    ..'\n\n[کانال ما](https://telegram.me/avirateam) و [لینک امتیاز](https://telegram.me/storebot?start=aviragpbot)',
            group_success = '_لیست دستورات را به پیوی شما ارسال کردم_',
            group_not_success = '_به من پیغام دهید تا بتوانم به شما پیغام دهم_',
            initial = 'دستور مورد نظر را انتخاب کنید:'
        },
        links = {
            no_link = 'لینکی برای این گروه تعیین نشده',
            link = '[&&&1](&&&2)',
            link_invalid = 'لینک مشکل دارد',
            link_updated = 'لینک تغییر یافت.\nلینک جدید: [&&&1](&&&2)',
            link_setted = 'لینک تعیین شد\nلینک: [&&&1](&&&2)',
            link_usetted = 'لینک تعیین نشده است',
            poll_unsetted = 'نظرسنجی تعیین نشده است',
            poll_updated = 'نظرسنجی تغییر یافت\nرای دهید: [&&&1](&&&2)',
            poll_setted = 'لینک تعیین شد\nرای دهید: [&&&1](&&&2)',
            no_poll = 'نظرسنجی برای این گروه وجود ندارد',
            poll = '*رای دهید*: [&&&1](&&&2)'
        },
        luarun = {
            enter_string = 'Please enter a string to load',
        ...
        mod = {
            not_owner = 'شما مدیر این گروه نیستید',
            reply_promote = 'بر روی فردی ریپلی کنید',
            reply_demote = 'بر روی فردی ریپلی کنید',
            reply_owner = 'بر روی فردی ریپلی کنید',
            already_mod = '&&&1 در حال حاظر مدیر &&&2 می باشد',
            already_owner = 'شما در حال حاظر مدیر این گروه هستید',
            not_mod = '&&&1 مدیر گروه &&&2 نیست',
            promoted = '&&&1 مدیر &&&2 شد',
            demoted = '&&&1 has been _demoted_',
            new_owner = '&&&1 مدیر &&&2 شد',
            modlist = 'لیست مدیران گروه &&&1\n&&&2'
        },
        report = {
            no_input = 'انتقادات و پیشنهادات و خود را در کنار /c بنویسید',
            sent = 'فیدبک ارسال شد:\n\n&&&1',
            reply = 'Reply to a feedback to reply to the user',
            reply_no_input = 'Write your reply next to "/reply"',
            feedback_reply = '*سلام این ریپلی صاحب ربات است*:\n&&&1',
            reply_sent = '*ریپلی ارسال شد*:\n\n&&&1',
        },
        service = {
            new_group = 'سلام به همه &&&1 مرا برای مدیریت اسان تر گروه   به گروه اد کرد برای مشاهده لیست دستورات /help را ارسال کنید :)',
            welcome = 'سلام &&&1 و به &&&2 خوش اومدی',
            welcome_rls = 'Total anarchy!',
            welcome_abt = 'متن توضیحاتی برای این گروه وجود ندارد',
            welcome_modlist = '\n\n*لیست مدیران*:\n',
            abt = '\n\n*توضیحات*:\n',
            rls = '\n\n*قوانین*:\n',
            bot_removed = '*&&&1* datas have been flushed.\nThanks for having used me!\nI\'m always here if you need an hand ;)'
        ...
        setabout = {
            no_bio = 'متن بیوگرافی برای گروه تعیین نشده',
            bio = '*متن توضیحات گروه*\n&&&1',
            no_bio_add = '*بیوگرافی برای گروه وجود ندارد جهت تعیین بیوگرافی از /setabout استفاده کنید  ',
            no_input_add = 'لطفا متنی بعد از "/addabout" بنویسید',
            added = '*توضیحات تعیین  شد:*\n"&&&1"',
            no_input_set = 'لطفا متنی بعد از "/setabout" بنویسید',
            clean = 'بیوگرافی پاک شد',
            new = '*بیوگرافی جدید:*\n"&&&1"'
        },
        setrules = {
            no_rules = '*Total anarchy*!',
            rules = '*قوانین گروه:*\n&&&1',
            no_rules_add = 'قوانینی برای این گروه وجود ندارد برای تعیین قوانین از /setrules استفاده کنید',
            no_input_add = 'لطفا متنی بعد از "/addrules"بنویسید ',
            added = '*قانون اضافه شد:*\n"&&&1"',
            no_input_set = 'لطفا متنی بعد از "/setrules"بنویسید"',
            clean = 'قوانین پاک شدند',
            new = '*قوانین جدید:*\n"&&&1"'
        },
        settings = {
            disable = {
                no_input = 'چه چیزی را غیر فعال کنم؟',
                rules_already = '`/rules` \n در  حال حاظر غیرفعال می باشد',
                rules_locked = '`/rules` \n از این به بعد فقط برای مدیران قابل استفاده می باشد',
                about_already = '`/about` \n در  حال حاظر غیرفعال می باشد',
                about_locked = '`/about` \n از این به بعد فقط برای مدیران قابل استفاده می باشد',
                welcome_already = 'پیغام خوش امد گویی در حال حاظر غیر فعال می باشد',
                welcome_locked = 'پیغام خوش امد گویی از این به بعد ارسال نمی شود',
                modlist_already = '`/modlist` \n در  حال حاظر غیرفعال می باشد',
                modlist_locked = '`/modlist` \n از این به بعد فقط برای مدیران قابل استفاده می باشد',
                flag_already = '`/flag` \n در  حال حاظر غیرفعال می باشد',
                flag_locked = '`/flag` \n از این به بعد در دسترس نخواهد بود',
                extra_already = '#extra \n در  حال حاظر غیرفعال می باشد',
                extra_locked = '#extra \n از این به بعد فقط برای مدیران قابل استفاده می باشد*',
                rtl_already = 'Anti-RTL \n در حال حاظر فعال می باشد',
                rtl_locked = 'Anti-RTL \n فعال شد',
                flood_already = 'Anti-flood \n در حال حاظر فعال می باشد',
                flood_locked = 'Anti-flood \n فعال شد',
                arab_already = 'Anti-arab \n فعال شد',
                arab_locked = 'Anti-arab \n فعال شد',
                report_already = '@admin \n در حال حاظر غیرفعال می باشد',
                report_locked = '@admin \n از این به بعد در دسترس نمی باشد',
                wrong_input = 'خطایی رخ داده است\n از /disable [rules|about|welcome|modlist|report|extra|rtl|arab] برای غیر فعال کردن استفاده کنید',
            },
            enable = {
                no_input = 'چه چیزی را فعال کنم؟',
                rules_already = '`/rules` \n در حال حاظر فعال می باشد',
                rules_unlocked = '`/rules` \n از این به بعد برای همه قابل استفاده می باشد',
                about_already = '`/about` \n در حال حاظر فعال می باشد',
                about_unlocked = '`/about` \n از این به بعد برای همه قابل استفاده می باشد',
                welcome_already = 'پیغام خوش امد گویی در حال حاظر فعال می باشد',
                welcome_unlocked = 'پیغام خوش امد گویی از این به بعد ارسال میشود',
                modlist_already = '`/modlist` \n در حال حاظر فعال می باشد*',
                modlist_unlocked = '`/modlist` \n از این به بعد برای همه قابل استفاده می باشد',
                flag_already = '`/flag` \n در حال حاظر در دسترس می باشد',
                flag_unlocked = '`/flag` \n از این به بعد در دسترس می باشد',
                extra_already = 'Extra # \n در حال حاظر فعال می باشد',
                extra_unlocked = 'Extra # \n از این به بعد برای همه قابل استفاده می باشد',
                rtl_already = 'Anti-RTL \n در حال حاظر غیر فعال می باشد',
                rtl_unlocked = 'Anti-RTL \nغیر فعال شد',
                flood_already = 'Anti-flood \nدر حال حاظر غیر فعال می باشد',
                flood_unlocked = 'Anti-flood \n غیر فعال شد',
                arab_already = 'Anti-arab \n در حال حاظر غیر فعال می باشد',
                arab_unlocked = 'Anti-arab \n غیر فعال شد',
                report_already = '@admin \n در حال حاظر در دسترس می باشد',
                report_unlocked = '@admin \n از این به بعد در دسترس می باشد',
                wrong_input = 'خطایی رخ داده \n از /enable [rules|about|welcome|modlist|report|extra|rtl|arab] برای فعال کردن استفاده کنید'
            },
            welcome = {
                no_input = 'خوش امد گویی و ...؟',
                a = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*درباره گروه*',
                r = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*قوانین*',
                m = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*لیست مدیران*',
                ra = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*قوانین*\n*درباره گروه*',
                rm = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*قوانین*\n*لیست مدیران*',
                am = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*درباره گروه*\n*لیست مدیران',
                ram = 'تنظیمات جدید برای پیغام خوش امد گویی:\n*قوانین*\n*درباره گروه*\n*لیست مدیران*',
                no = 'تنظیمات جدید برای پیغام خوش امد گویی:\nمعمولی',
                wrong_input = 'خطایی رخ داده \n از _/welcome [no|r|a|ra|ar]_ برای تعیین نوع پیغام خوش امد گویی استفاده کنید',
                custom = 'پیغام خوش امد گویی مورد نظر شما تعیین شد \n\n&&&1',
                wrong_markdown = 'خطایی رخ داده،من نمیتوانم متن را تشخیص دهم لطفا متن را برسی کنید',
            },
            resume = {
                header = 'تنظیمات کنونی *&&&1*:\n\n*زبان*: `&&&2`\n',
                w_a = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + درباره گروه`\n',
                w_r = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + قوانین`\n',
                w_m = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + لیست مدیران`\n',
                w_ra = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + قوانین + درباره گروه`\n',
                w_rm = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + قوانین + لیست مدیران`\n',
                w_am = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + درباره گروه + لیست مدیران`\n',
                w_ram = '*نوع پیغام خوش امد گویی*: `خوش امد گویی + قوانین + درباره گروه + لیست مدیران`\n',
                w_no = '*نوع پیغام خوش امد گویی*: `خوش امد گویی فقط`\n',
                flood_info = '_میزان حساسیت به اسپم:_ *&&&1* (_action:_ *&&&2*)\n'
            },
            Rules = 'قوانین',
            About = 'توضیحات',
            Welcome = 'پیغام خوش امدگویی',
            Modlist = 'لیست مدیران',
            Flag = 'فلگ',
            Extra = 'دستورات اضافی',
            Flood = 'حساسیت به اسپم',
            Rtl = 'راست به چپ',
            Arab = 'عربی',
            Report = 'ریپورت'
        },
        shell = {
            no_input = 'لطفا دستوری را برای اجرا ارسال کنید',
            done = 'تمام شد',
            output = '```\n&&&1\n```'
        },
        tell = {
            first_name = '*نام*: &&&1\n',
            last_name = '*نام خانوادگی*: &&&1\n',
            group_name = '\n*نام گروه*: &&&1\n',
            group_id = '*ایدی گروه*: &&&1'
        },
        warn = {
            warn_reply = 'بر روی فردی برای هشدار دادن ریپلی کنید',
            changed_type = 'واکنش جدید به حداکثر هشدار ها: *&&&1*',
            mod = 'مدیران نمی تواننند هشدار دریافت کنند',
            warned_max_kick = 'کاربر &&&1 کیک شد علت:دریافت حداکثر میزان هشدار',
            warned_max_ban = 'کاربر &&&1 بن شد علت: دریافت حداکثر میزان هشدار',
            warned = 'کاربر &&&1 هشدار دریافت کرد\n_تعداد هشدار ها_   *&&&2*\n_حداکثر_   *&&&3* (*-&&&4*)',
            warnmax = 'میزان حداکثر هشدار تغییر یافت\nمیزان قدیمی: &&&1\nمیزان جدید: &&&2',
            getwarns_reply = 'برای دریافت تعدا هشدرا های فرد بر روی فرد ریپلی کنید',
            limit_reached = 'این فرد در حال حاظر حداکثر میزان هشدار را دریافت کرده (*&&&1/&&&2*)',
            limit_lower = 'تعداد هشدار های این فرد کمتر از میزان حداکثر است\n*&&&1* warnings missing on a total of *&&&2* (*&&&3/&&&4*)',
            nowarn_reply = 'برای ریست کردن هشدار ها بر روی فرد ریپلی کنید',
            nowarn = 'تعداد هشدار ها 0 شد'
        },
        setlang = {
            list = '*لیست زبان های موجود:*\n\n&&&1\nبرای تغییر زبان از /lang code استفاده کنید',
            error = 'زبان انتخاب شده پشتیبانی نمیشود\n برای مشاهده لیست زبان های موجود از /lang استفاده کنید',
            success = '*زبان جدید تنظیم شد:* &&&1'
        },
		banhammer = {
            kicked_header = 'تعداد افراد کیک شده:\n\n',
            kicked_empty = 'لیست افراد کیک شده خالی است',
            kicked = 'کاربر &&&1 کیک شد',
            banned = 'کاربر &&&1 بن شد',
            already_banned_normal = 'کاربر &&&1 در حال حاظر بن می باشد',
            unbanned = 'کاربر &&&1 ان بن شد',
            reply = 'بر روی فردی ریپلی کنید',
            globally_banned = 'کاربر &&&1 گلوبالی بن شد',
            not_banned = 'کاربر &&&1 ان بن نیست'
        },
        floodmanager = {
            number_invalid = 'خطا \n عدد انتخاب شده باید بین سه و بیست و شش باشد',
            not_changed = 'میزان حساسیت به اسپم در حال حاظر &&&1 می باشد',
            changed = 'میزان حساسیت به اسپم از &&&1 به &&&2 تغییر یافت',
            enabled = 'ضداسپم فعال شد',
            disabled = 'ضد اسپم غیر فعال شد',
            kick = 'از این به بعد اسپمر ها کیک میشوند',
            ban = 'از این به بعد اسپمر ها بن میشوند',
        },
        mediasettings = {
			warn = 'این نوع رسانه در این گروه مجاز نیست\n در صورت تکرار کیک یا بن میشوید',
            list_header = '*لیست رسانه هایی که میتوانید ممنوع کنید*:\n\n',
            settings_header = '*تنظیمات کنونی رسانه ها*:\n\n',
            already = 'وضعیت (&&&1) در حال حاظر (&&&2) می باشد',
            changed = 'تنظیمات جدید برای (`&&&1`) = *&&&2*',
            wrong_input = 'خطا،از /medialist برای مشاهده لیست رسانه ها استفاده کنید',
        },
        preprocess = {
            flood_ban = 'کاربر &&&1 به علت اسپم  بن شد',
            flood_kick = 'کاربر &&&1 به علت اسپم  کیک شد',
            media_kick = 'کاربر &&&1 به علت ارسال رسانه غیر مجاز کیک شد',
            media_ban = 'کاربر &&&1 به علت ارسال رسانه غیر مجاز بن شد',
            rtl = 'کاربر &&&1 به علت استفاده از کرکتر های عربی یا فارسی در اسم یا چت کیک شد',
            arab = 'کاربر &&&1 کیک شد به علت استفاده از کرکتر های عربی یا فارسی در چت',
            first_warn = 'این نوع رسانه در این گروه مجاز نیست دفعه بعد, *&&&1*'
        },
        broadcast = {
            delivered = 'Broadcast delivered. Check the log for the list of reached ids',
            no_users = 'No users saved, no broadcast',
        ...
        admin = {
            no_reply = 'این دستور به ریپلی نیاز دارد',
            blocked = 'کاربر &&&1 بلاک شد',
            unblocked = 'کاربر &&&1 ان بلاک شد',
            already_blocked = 'کاربر &&&1 در حال حاظر در لیست سیاه است',
            already_unblocked = 'کاربر &&&1 در حال حاظر انبلاک است',
            bcg_no_groups = 'گروهی وجود ندارد',
            leave_id_missing = 'ID missing',
            leave_chat_leaved = 'از چت خارج شد',
            leave_error = 'خطا ،ایدی را برسی کنید'
            
        },
        kick_errors = {
            [101] = 'خطا،من مدیر نیستم',
            [102] = 'خطا،من قادر به کیک یا بن مدیران نیستم',
            [103] = 'نیازی به ان بن در گروه معمولی نیست',
            [104] = 'خطا،من قادر به کیک یا بن مدیران نیستم', --yes, I need two
            [105] = 'خطا،من مدیر نیستم',
            [106] = 'این فرد در گروه نیست',
            [107] = 'خطایی در هنگام کیک رخ داده',
        },
        flag = {
            no_input = 'بر روی پیغامی برای گزارش به مدیر ریپلی کنید یا بعد از @admin چیزی بنویسید',
            reported = 'ریپورت شد',
            no_reply = 'بر روی فرد ریپلی کنید',
            blocked = 'کاربران از این به بعد میتوانند از @admin استفاده کنند',
            already_blocked = 'کاربر قادر به استفاده از @admin نیست',
            unblocked = 'کاربران از این به بعد میتوانند از @admin استفاده کنند',
            already_unblocked = 'کاربر قادر به استفاده از @admin است',
        },
        all = {
            dashboard = 'من مشخصات گروه را به پیوی شما ارسال کردم',
            menu = 'من تنظیمات گروه را به پیوی شما ارسال کردم',
            dashboard_first = 'مشاهده مشخصات گروه',
            menu_first = 'برای تغییر تنظمیات بر روی قفل ها کلیک کنید یا از + و - برای تغییر میزان حساسیت اسپم استفاده کنید',
            media_first = 'از ستون های سمت راست برای تغییر تنظیمات رسانه استفاده کنید'
        },
    },
	it = {
	    bonus = {
        ...
        help = {
            ...
            all = '*Comandi per tutti*:\n'
                    ...
                    ..'`/help` : show this message.'
		            ..'\n\nSe ti piace questo bot, per favore lascia il voto che credi si meriti [qui](https://telegram.me/storebot?start=Aviragpbot)',
		    private = 'Hey, *&&&1*!\n'
                    ...
                    ..'\n\n[Canale ufficiale](https://telegram.me/avirateam) e [link per votarmi](https://telegram.me/storebot?start=Aviragpbot)',
	...
	es = {
        ...
        help = {
            ...
            all = '*Comandos para todos*:\n'
		            ...
		            ..'\n\nSi te gusta este bot, por favor deja tu voto [aqui](https://telegram.me/storebot?start=Aviragpbot)',
		    private = 'Hola, *&&&1*!\n'
                    ...
                    ..'\n\n[Canal OFICIAL](https://telegram.me/avirateam) y el [link para votar](https://telegram.me/storebot?start=Aviragpbot)',
    ...
    br = {
        ...
        help = {
            ...
            all = '*Comandos para todos*:\n'
		            ...
		            ..'\n\nSe você gosta deste bot, por favor vote no quanto você acha que ele merece [aqui](https://telegram.me/storebot?start=Aviragpbot)',
		    private = 'Olá, *&&&1*!\n'
                    ...
                    ..'\n\n[Canal Oficial](https://telegram.me/avirateam) and [vote link](https://telegram.me/storebot?start=Aviragpbot)',
